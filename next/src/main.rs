...
use sandk_offroad_next::{
    ...
    CameraPlugin, CareerPlugin, ChangelogPlugin, CollectiblesPlugin, CompassPlugin,
    ConfettiPlugin, ConfigPlugin, CoursePlugin, CreditsPlugin, DailyPlugin, DamagePlugin,
    DecalsPlugin, DemoModePlugin, DronePlugin, DustPlugin, EngineProPlugin,
    EventLogPlugin, ExhaustPlugin, FontAssetsPlugin, FuelPlugin, GaugePlugin,
    GodraysPlugin, HeadlightsPlugin, HelpPlugin, HornPlugin, HudPlugin, InputRemapPlugin,
    LiveryPlugin, LoadingScreenPlugin, MapSelectPlugin, MapsPlugin, MarkersPlugin,
    MedalsPlugin, MenuPlugin, MinimapPlugin, MixerPlugin, MudPlugin, MusicPlugin,
    ObstaclesPlugin, PerfPlugin, PhotoModePlugin, PinsPlugin, ProgressionPlugin,
    RacePlugin, RampsPlugin, RecoveryPlugin, RepairPlugin, ReplayPlugin, RivalHudPlugin,
    RivalPlugin, RoutePlugin, SavePlugin, ScatterPlugin, ScreenshotPlugin, SettingsPlugin,
    ...
    ThemePlugin, TrailPlugin, TrampolinesPlugin, TransitionPlugin, TrialPlugin,
    TutorialPlugin, UnlocksPlugin, VariantsPlugin, VehicleDirtPlugin, VehiclePlugin,
