...
use sandk_offroad_next::{
    ...
    AirtimePlugin, ArrowPlugin, AsciiLogoPlugin, AudioPlugin, BannersPlugin,
    BenchmarkPlugin, BiomeCanyonPlugin, BiomeDesertPlugin, BirdsFlockPlugin,
    BloomPpPlugin, BoostPlugin, BreadcrumbsPlugin, BuildingsPlugin, CameraPlugin,
