...
//
// Save location:
//   Linux  : $XDG_DATA_HOME/sandk-offroad/screenshots/sandk_<unix_ts>.png
//          — fallback: $HOME/.local/share/sandk-offroad/screenshots/sandk_<unix_ts>.png
//   Windows: $APPDATA/sandk-offroad/screenshots/sandk_<unix_ts>.png
//   macOS  : $HOME/Library/Application Support/sandk-offroad/screenshots/sandk_<unix_ts>.png
...
fn resolve_screenshot_path() -> PathBuf {
    ...
    match base {
        Some(dir) => dir.join("sandk-offroad").join("screenshots").join(&filename),
        None => {
