...
use sandk_offroad_next::{
    ...
    AirtimePlugin, ArrowPlugin, AudioPlugin, BannersPlugin, BenchmarkPlugin,
    BiomeCanyonPlugin, BiomeDesertPlugin, BloomPpPlugin, BoostPlugin, BreadcrumbsPlugin,
    CameraPlugin, CareerPlugin, ChallengesPlugin, ChangelogPlugin, CollectiblesPlugin,
    CompassPlugin, ConfettiPlugin, ConfigPlugin, CoursePlugin, CreditsPlugin,
    DailyPlugin, DamagePlugin, DecalsPlugin, DemoModePlugin, DemolitionPlugin,
    DronePlugin, DustPlugin, EngineProPlugin, EventLogPlugin, ExhaustPlugin,
    ExplorePlugin, FontAssetsPlugin, FuelPlugin, GaugePlugin, GodraysPlugin,
    HeadlightsPlugin, HelpPlugin, HornPlugin, HudPlugin, InputRemapPlugin, LiveryPlugin,
    LoadingScreenPlugin, MapSelectPlugin, MapsPlugin, MarkersPlugin, MedalsPlugin,
    MenuPlugin, MinimapPlugin, MixerPlugin, MudPlugin, MusicPlugin, ObstaclesPlugin,
    PerfPlugin, PhotoModePlugin, PinsPlugin, ProgressionPlugin, PursuitPlugin,
    RacePlugin, RampsPlugin, RecoveryPlugin, RepairPlugin, ReplayPlugin, RivalHudPlugin,
    RivalPlugin, RoutePlugin, SavePlugin, ScatterPlugin, ScreenshotPlugin,
    SettingsPlugin, ShakePlugin, SkidmarksPlugin, SkyPlugin, SpeedLinesPlugin,
    SpeedTrapPlugin, StarsPlugin, StatsScreenPlugin, StormPlugin, SurfacesPlugin,
    TerrainPlugin, ThemePlugin, TimeTrialPlugin, TrailPlugin, TrampolinesPlugin,
    TransitionPlugin, TrialPlugin, TutorialPlugin, UnlocksPlugin, VariantsPlugin,
    VehicleDirtPlugin, VehiclePlugin, WaterPlugin, WheelieCounterPlugin, WindPlugin,
    WorldAudioPlugin, XpPlugin,
};
