...
use sandk_offroad_next::{
    ...
    BiomeDesertPlugin, BirdsFlockPlugin, BloomPpPlugin, BoostPlugin, BreadcrumbsPlugin,
    BuildingsPlugin,
    ...
    DamageVisualPlugin, DecalsPlugin, DemoModePlugin, DemolitionPlugin, DronePlugin,
    DustPlugin, EngineProPlugin, EventLogPlugin, ExhaustPlugin, ExhaustSmokePlugin,
    ExplorePlugin, FastTravelMenuPlugin, FireworksPlugin, FontAssetsPlugin, FuelPlugin,
    GaragePlugin, GasStationsPlugin, GaugePlugin, GodraysPlugin, HeadlightsPlugin,
    ...
    TireSmokePlugin, TrafficPlugin, TrailPlugin, TrampolinesPlugin, TransitionPlugin,
    TrialPlugin,
