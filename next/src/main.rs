...
use sandk_offroad_next::{
    ...
    GaragePlugin, GaugePlugin, GodraysPlugin, HeadlightsPlugin, HelpPlugin, HornPlugin,
    HudPlugin, InputRemapPlugin, IntroVideoPlugin, JumpMeterPlugin, LandmarksPlugin,
    ...
    TrafficPlugin, TrailPlugin, TrampolinesPlugin, TransitionPlugin, TrialPlugin,
